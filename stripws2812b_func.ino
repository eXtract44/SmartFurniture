...
#define speed_step_light 60  //mS Light speed_step animation numbers
#define delay_light 30       //mS Light delay animation numbers
...
void draw_number_fast(const uint8_t number, const uint8_t x, const uint8_t y, const uint8_t r, const uint8_t g, const uint8_t b) {
  clear_number_fast(x, y);
  switch (number) {
    case 0:
      //step one
