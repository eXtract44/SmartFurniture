...
void debug_uart_esp(){
  //Serial.println( esp_data.temp);
  //Serial.println( esp_data.humidity);

  Serial.print("Temperature ESP: "); Serial.print(get_temperature_esp()); Serial.println(" degrees C");
 
  Serial.print("Humidity ESP: "); Serial.print(get_humidity_esp()); Serial.println("% rH");
}
